...
function bandpromo_asset_build_audio_display_from_inspect(array $inspect, string $releaseTitle = '', array $preserveDisplay = []): array
{
    ...
    return [
        ...
        'artist' => $artist,
        'featured_artist' => trim((string) ($inspect['featured_artist'] ?? $preserve['featured_artist'] ?? '')),
        'remix_artist' => trim((string) ($inspect['remix_artist'] ?? $preserve['remix_artist'] ?? '')),
...
function bandpromo_asset_build_audio_display_from_fields(array $fields, array $inspectData = [], array $preserveDisplay = []): array
{
    ...
    return [
        ...
        'version' => $labels['version'],
        'artist' => $artist,
        'featured_artist' => trim((string) ($fields['featured_artist'] ?? '')),
        'remix_artist' => trim((string) ($fields['remix_artist'] ?? '')),
        'album' => $album,
        'duration' => $duration,
